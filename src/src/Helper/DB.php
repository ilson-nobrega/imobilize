...
class DB {
    ...
    private function __construct() {
        self::$connection = new PDO("mysql:dbname=" . dbFactoryData['database'] . ";host=" . dbFactoryData['host'],
            dbFactoryData['username'], dbFactoryData['password'],array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
